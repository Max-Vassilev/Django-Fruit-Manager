...
The website checks if there is a created profile. If the user doesn't have one, it opens a form which makes an instance of Profile (creates the profile). When the user is logged in to his/her account they can add fruits (instances of the Fruit model). They can also edit and delete their fruits (CRUD operations). 
